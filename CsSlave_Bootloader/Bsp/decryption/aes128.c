...
* Version            : V1.0.0
* Date               : 10/06/2008
* Description        : AES 128-bit key main program body
********************************************************************************
...
/******************************************************************************
 ...
 The value of AES_IMPLEMENTATION is automatically set according to 
 the define CRL_AES_ALGORITHM in Config.h.
*******************************************************************************/
#if CRL_AES_ALGORITHM==1
	#define AES_IMPLEMENTATION 1
#elif CRL_AES_ALGORITHM==2
...
/* Private macro -------------------------------------------------------------*/
/* These operations extract a byte from an uint32_t data: */
...
/* Return an uint32_t from 4 uint8_t */
#define WORD8_TO_WORD32(b0, b1, b2, b3) ((uint32_t)(b0) << 24 | (uint32_t)(b1) << 16 | (uint32_t)(b2) << 8 | (b3))
...
* Return         : None
*******************************************************************************/
void AES_keyschedule_enc(uint32_t* key, uint32_t* expkey)	
{
...
* Return         : None
*******************************************************************************/
void AES_keyschedule_dec(uint32_t* key, uint32_t* expkey)
{
  register uint32_t* local_pointer = expkey;
  register int i = 0;
  register uint32_t copy0;
